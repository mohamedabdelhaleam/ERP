                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img
                                src="{{ asset('img/author-nav.jpg') }}" alt="" class="rounded-circle">
                            @if (Auth::check())
                                    ...
                                    <ul>
                                        <li id="ChangePassword">
                                            <a style="cursor: pointer">
                                                <img src="{{ asset('img/svg/settings.svg') }}" alt="settings"
                                                    class="svg">{{ __('auth.change_password') }}</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="nav-author__options">
                                        <form method="POST" action="{{ route('logout') }}"
                                            ...
                                            <button type="submit"
                                                ...
                                                <i class="uil uil-sign-out-alt"></i>{{ __('auth.logout') }}
                                            </button>
                                        </form>
                                    </div>
                                </div>
